<h1 class="heading"><?php if(1)  echo ''; ?> Add Airtel Department </h1>
...
<?php echo form_open('dnd_controllers/department/add_airtel_department', array('class' => 'form-horizontal' , 'onsubmit' => 'return form_validation();')); ?>
...
<input type="hidden" name="brand_name" value="airtel" class="" >
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <?php echo form_open('dnd_controllers/department/edit_airtel_department', array('class' => 'form-horizontal' , 'onsubmit' => 'return form_validation();')); ?>

          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Airtel Department Update</h4>
          </div>
...
<input type="hidden" id="brand_name" name="brand_name" value="airtel" class="" >
<input type="hidden" value="1" name="is_active" id="is_active" />
                <div class="form-group">
