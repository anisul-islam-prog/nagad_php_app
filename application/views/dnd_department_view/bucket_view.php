<h1 class="heading"><?php if(1)  echo ''; ?> Airtel Bucket Management </h1>
    ...
    <!-- Nav tabs -->
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="home">
                <hr>
                <?php echo form_open('dnd_controllers/department/add_airtel_bucket', array('class' => 'form-horizontal' , 'onsubmit' => 'return form_validation();')); ?>                   
					...
					<div class="form-group formSep">
                        <label class="col-sm-2 control-label" for="bucket_priority">Bucket Priority:</label>
                        <div class="col-sm-4">
						     <input type="text" readonly placeholder="" name="bucket_priority" id="bucket_priority"  class="form-control input-sm" />
                           
                        </div>
                    </div>
					
					<div class="form-group formSep">
                        <label class="col-sm-2 control-label" for="bucket_quota">Quota:</label>
                        <div class="col-sm-4">
						     <input type="text"  placeholder="Enter Quota" name="bucket_quota" id="bucket_quota"  class="form-control input-sm" />
							 <input type="hidden" name="brand_value" id="brand_value" value="Airtel" />
                    ...
                    <div class="form-group formSep">
                        ...
                        <div class="col-sm-4">
                           <select name="bucket" id="bucket" required name="Department" class="chosen-select form-control"'>
                                ...
                                <?php foreach ($airtell_bucket_all as $keys) {
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <?php echo form_open('dnd_controllers/department/edit_airtel_bucket', array('class' => 'form-horizontal' , 'onsubmit' => 'return form_validation();')); ?>
          ...
          <input type="hidden" id="id" name="bid">
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="airtel_bucket_name">Bucket Name:</label>
                    <div class="col-sm-4">
                        <input type="text" required name="abname" id="abname"  class="form-control input-sm" />
                    </div>
                </div>
				<div class="form-group formSep">
                        <label class="col-sm-4 control-label" for="bpriority">Bucket Priority:</label>
                        <div class="col-sm-4">
						     <input type="text" placeholder="" name="bpriority" id="bpriority"  class="form-control input-sm" />
                           
                        </div>
                </div>
				
				<div class="form-group formSep">
                        <label class="col-sm-4 control-label" for="bquota">Quota:</label>
                        <div class="col-sm-4">
						     <input type="text" placeholder="" name="bquota" id="bquota"  class="form-control input-sm" />
							 <input type="hidden" name="b_value" id="b_value" value="Airtel" />
							 <input type="hidden" name="b_last_priority" id="b_last_priority"  />
...
<script type="text/javascript">
    ...
    $('button[data-toggle=modal], button[data-toggle=modal]').click(function () {
        var id          = $(this).data('id');
        var abname     = $(this).data('abname');
			  var bpriority  = $(this).data('prioritys');
