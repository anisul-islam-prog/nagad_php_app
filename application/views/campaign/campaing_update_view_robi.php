<h1 class="heading"><?php if (1) echo ''; ?> Update Campaign </h1>
...
<?php echo form_open('dnd_controllers/campaign/update_campaign_robi', array('class' => 'form-horizontal', 'onsubmit' => 'return form_validation();')); ?>
	...
	<input type="hidden" name="broadcast_date" value="<?php echo $campaignDetails[0]['BROADCAST_DATE']; ?>" >
...
<?php  //if($campaignDetails[0]['CATEGORY_ID'] == 7 ) echo "OK";?>
    ...
    <div class="form-group formSep">
        ...
        <div class="col-sm-4">
            <textarea name="campaign_text" id="campaign_text" rows="6" class="form-control"><?php echo $campaignDetails[0]['CAMPAIGN_TEXT'] ?></textarea>
            <!--<input type="text" name="campaign_text" id="campaign_text" value="" class="form-control"  />-->
            <span class="help-inline">Total: <span id="c_text_count"> <?php echo strlen($campaignDetails[0]['CAMPAIGN_TEXT']); ?> </span> Characters</span>
        </div>
    </div>
	...
	<div class="form-group formSep"  >
        ...
        <div class="col-sm-2">
            ...
            <input type="hidden" name="old_priority" id="old_priority" value="<?php echo $campaignDetails[0]['PRIORITY'] ?>" />
            <input type="text" name="priority"  id="priority" class="form-control" value="<?php echo $campaignDetails[0]['PRIORITY'] ?>" />
        </div>
    </div>
    ...
    <div class="form-group formSep">
        ...
        <div class="controls col-sm-4">
            <select id="commvet" name="commvet" class="chosen-select form-control" >
                <?php $cat = campaign_commvet_list();  foreach($cat as $key => $value) { ?>
				
				<?php if($key == $campaignDetails[0]['COMMVET']){ ?>
				<option selected value="<?php echo $key; ?>"><?php echo $value; ?></option>
				<?php }else{ ?>
				<option value="<?php echo $key; ?>"><?php echo $value; ?></option>
				<?php } } ?>
...
function form_validation(){
    ...
    if(priority=='' || priority==null){
	 ...
	 if(base=='' || base==null || base.length===0){
		 
            alert('Please Base File'); 
            return false;
        }
