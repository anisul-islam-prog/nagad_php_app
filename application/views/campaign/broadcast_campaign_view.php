<h1 class="heading"><?php if (1) echo ''; ?> Broadcast Airtel Campaign </h1>
...
<div class="col-sm-12">
  ...
  <div class="row-fluid">
    			<?php echo form_open('dnd_controllers/campaign/update_campaign_global_priority',  array('class' => 'form-horizontal', 'onsubmit' => 'return form_priority_validation();')); ?>

            <div class="span12">
                 <table class="table table-bordered table-striped" id="broadcast_airtel_table" style="margin-bottom: 0;">
                    <thead>
                    <tr>
                        <th>Campaign ID</th>
                        <th>Campaign Name</th>
                    ...
                    <tr>
						...
						<td><a type="button" href="<?php echo site_url('dnd_controllers/campaign/start_download_process/'.$key['CAMPAIGN_ID']); ?>"  <?php if($key['DOWNLOAD_TARGET']=='1') { echo 'disabled ';}?> style="font-size:12px;" class="btn btn-success pull-right <?php if($key['DOWNLOAD_TARGET']=='1') { echo 'deactive_btn ';}?>" name="download_process" id="download_process" > Start Download Process</a></td>
		...
		<div class="" style="margin-top:20px!important;clear:right;"> 
					<a type="button" href="<?php echo site_url('dnd_controllers/campaign/start_broadcast'); ?>" style="clear:left;margin-top:20px;" class="btn btn-success pull-right " name="broadcast_campaign" id="broadcast_campaign" <?php if($broadcast_btn_status=='false') { echo 'disabled';} else{ echo '';} ?> > Broadcast Campaign</a>
...
<script>
    $(document).ready(function() {
        $('#broadcast_airtel_table').DataTable(		
		{
			 scrollY:        "330px",
        scrollX:        "300px;",
        scrollCollapse: true,
