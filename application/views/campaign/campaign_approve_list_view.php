<h1 class="heading"><?php if(1)  echo ''; ?>Approve Airtel Campaigns</h1>
...
<div class="col-sm-12">
  ...
  <div class="row-fluid">
  			<?php echo form_open('dnd_controllers/campaign/base_generate',  array('class' => 'form-horizontal', 'onsubmit' => '')); ?>
