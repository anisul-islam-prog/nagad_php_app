<h1 class="heading"><?php if(1)  echo ''; ?>Campaign List</h1>
...
<!--
<form style="margin-bottom: 3px; margin-left: 15px;" action="<?php echo base_url('dnd_controllers/campaign/campaing_list'); ?>" method="POST"> 
    <div class="row">
...
<div class="col-sm-12">
  ...
  <div class="row-fluid">
            <div class="span12">
                 <table class="table table-bordered table-striped" id="camapaign_list_table" style="margin-bottom: 0;">
                    <thead>
                    <tr>
                        <th>Team</th>
                        <th>Category</th>
                    ...
                    <tr>
                        ...
                        <a href="<?php echo base_url('dnd_controllers/campaign/campaign_update_view/'.$key['ID'].'');?>"  data-dynamic="<?php echo $key['IS_DYNAMIC']; ?>"  <?php if($key['IS_APPROVED']==1){ echo 'disabled'; }?>  class="btn btn-sm btn-success <?php if($key['IS_APPROVED']==1){ echo 'deactive_btn'; }?>" >update</a>
...
$(document).ready(function() {
        $('#camapaign_list_table').DataTable(
		{
			 scrollY:        "360px",
        scrollX:        "30px;",
        scrollCollapse: true,
