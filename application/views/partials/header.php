...
<div id="maincontainer" class="clearfix">
    ...
    <header><div class="navbar navbar-fixed-top"><div class="navbar-inner"><div class="container-fluid">
        ...
        <a class="brand" href="<?php echo base_url().'administrator/dashboard'; ?>"><i class="glyphicon glyphicon-home glyphicon-white"></i> <?php echo str_replace(':: ', '&nbsp;', $this->site_name); ?></a>
            ...
            <li>
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $this->session->userdata('user_name'); ?> <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo base_url().'dnd_controllers/user_management/edit_profile' ?>"> <i class="glyphicon glyphicon-user"></i> Update Profile</a></li>
                  <li><a href="<?php echo base_url().'dnd_controllers/user_management/change_password' ?>"><i class="glyphicon glyphicon-refresh"></i> Change Password</a></li>
